...
class JobPost(BaseModel):
    ...
    # ARCHIMED : niveau d'études demandé par l'annonce, quand la source le donne
    # (Welcome to the Jungle) ou qu'on l'a déduit du texte (voir filters.py).
...
class Site(Enum):
    ...
    GLASSDOOR = "glassdoor"
    GOOGLE = "google"
    # Ajouts ARCHIMED : deux plateformes majeures du marché francophone.
    HELLOWORK = "hellowork"
